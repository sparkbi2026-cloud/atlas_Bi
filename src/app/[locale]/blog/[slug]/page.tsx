...
export async function generateMetadata({ params }: { params: Promise<{ slug: string; locale: string }> }): Promise<Metadata> {
  ...
  const post = getPostBySlug(slug, locale as any);
  ...
  return {
    ...
    openGraph: {
      ...
      type: "article",
      url: `https://atlasbi.live/${locale}/blog/${slug}`,
      ...
      <header className="relative pt-48 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="max-w-4xl">
            ...
            <div className="relative aspect-[21/9] w-full rounded-[40px] overflow-hidden mb-12 shadow-2xl border border-slate-100 bg-slate-50">
              <img 
                src={post.heroImage || "https://images.unsplash.com/photo-1551288049-bbbda536639a?q=80&w=1200"} 
                alt={post.title}
